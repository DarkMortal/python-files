# I wrote this script to compute
# the list of classes I missed during my leave
...
if __name__=="__main__":
    start=datetime.datetime(2022,3,14) #start-date
    end=datetime.datetime(2022,4,1) #end-date
